...
class ScreenshotDetector(private val context: Context) {
        ...
        context.contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                if (path.contains("screenshot", true)) {
                    // do something
                    Toast.makeText(context, "ScreenShot taken from query data column", Toast.LENGTH_LONG).show()
                }
            }
        }
    }
        ...
        context.contentResolver.query(
            ...
            while (cursor.moveToNext()) {
                ...
                if (name.contains("screenshot", true) or
                    ...
                    // do something
                    Toast.makeText(context, "screenshot from relative column", Toast.LENGTH_LONG).show()
                }
            }
        }
    }
    ...
    private fun ContentResolver.registerObserver(): ContentObserver {
        ...
        registerContentObserver(Media.EXTERNAL_CONTENT_URI, true, contentObserver)
