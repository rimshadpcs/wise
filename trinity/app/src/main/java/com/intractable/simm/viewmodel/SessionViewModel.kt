...
class SessionViewModel:ViewModel() {
    ...
    public fun checkForNextQuestion(){
        ...
        if (page < ListActivity[com.intractable.simm.ProgressManager.instance.sessionNumber].activityList!!.size-1) {
            Log.e("next","sd")
            page++
    ...
    fun getProgress(){
        if (com.intractable.simm.ProgressManager.instance.sessionNumber<ListActivity.size) {
            var num = ListActivity[com.intractable.simm.ProgressManager.instance.sessionNumber].activityList!!.size
            var i = 100 / num
